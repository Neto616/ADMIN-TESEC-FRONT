...
export default function ProductoForm({
  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        clave_sat: initialData.clave_sat || "",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.nombre || !formData.id_proveedor || !formData.marca) {
      return Swal.fire(
        "Atención",
        "Nombre, Marca y Proveedor son obligatorios",
        "warning",
      );
    }
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7A00] outline-none"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7A00] outline-none"
                        placeholder="Samsung"
                      />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7A00] outline-none bg-white"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7A00] outline-none resize-none"
                ...
                <div className="bg-green-50/50 p-3 rounded-xl border border-green-100">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full pl-7 pr-3 py-2 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 outline-none"
                    />
                  </div>
                </div>
                <div className="bg-gray-50 p-3 rounded-xl border border-gray-200">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-7 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF7A00] outline-none"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
              ...
              <label className="border-2 border-dashed border-gray-300 rounded-xl p-4 block cursor-pointer hover:bg-white hover:border-[#FF7A00] transition-all text-center group">
                <UploadCloud
                  size={24}
                  className="mx-auto text-gray-400 group-hover:text-[#FF7A00] mb-2"
                />
